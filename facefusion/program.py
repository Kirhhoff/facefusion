...
def create_face_selector_program() -> ArgumentParser:
	...
	group_face_selector.add_argument('--face-debug', help = 'Enable face detection debug prints', action = 'store_true', default = config.get_bool_value('face_selector', 'face_debug'))
	...
	job_store.register_step_keys([ 'face_selector_mode', 'face_selector_order', 'face_selector_gender', 'face_selector_race', 'face_selector_age_start', 'face_selector_age_end', 'reference_face_position', 'reference_face_distance', 'reference_frame_number', 'face_debug' ])
	return program
