...
def create_face_selector_program() -> ArgumentParser:
	...
	group_face_selector.add_argument('--face-swap-debug', help = 'Enable face swap debug prints', action = 'store_true', default = config.get_bool_value('face_selector', 'face_swap_debug'))
	...
	job_store.register_step_keys([ 'face_selector_mode', 'face_selector_order', 'face_selector_gender', 'face_selector_race', 'face_selector_age_start', 'face_selector_age_end', 'reference_face_position', 'reference_face_distance', 'reference_frame_number', 'face_swap_debug' ])
	return program
...
def create_execution_program() -> ArgumentParser:
	...
	group_execution.add_argument('--gpu-mem-limit', help = translator.get('help.gpu_mem_limit'), type = int, default = config.get_int_value('execution', 'gpu_mem_limit', '0'), metavar = 'GPU_MEM_LIMIT')
	job_store.register_job_keys([ 'execution_device_ids', 'execution_providers', 'execution_thread_count', 'gpu_mem_limit' ])
	return program
